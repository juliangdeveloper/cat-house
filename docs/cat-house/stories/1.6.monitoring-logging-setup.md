...
- [ ] Implement Prometheus metrics endpoints (AC: 1)
  - [ ] Add prometheus_client to all 4 production services
  - [ ] Create metrics middleware for HTTP requests
  - [ ] Add database connection pool metrics
  - [ ] Expose /metrics endpoint
  - [ ] Test metrics collection locally (including health-aggregator for dev)
...
- [ ] Create CloudWatch dashboards (AC: 2)
  - [ ] Service health dashboard (4 production services)
