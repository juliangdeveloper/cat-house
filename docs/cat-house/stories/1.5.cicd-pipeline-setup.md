...
**Pending:**
- Deploy Terraform to AWS (requires AWS credentials)
- Configure GitHub Secrets (AWS keys, Neon DB URLs, CloudFront IDs)
- Test workflows in actual GitHub Actions environment
- Create ECS services (requires VPC, subnets, security groups)
