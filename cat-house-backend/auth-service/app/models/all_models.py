...
instperm_module_code = (install_models_path / "installation_permission.py").read_text(encoding='utf-8')
...
# Export all models
__all__ = ['Base', 'BaseModel', 'User', 'Cat', 'Permission', 'Installation', 'InstallationPermission']
